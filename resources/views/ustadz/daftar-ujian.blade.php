...
<div class="col-md-6 col-lg-12 col-12 mb-2 col-sm-9">
    ...
    <div class="media shadow-sm p-0 bg-{{$ujian->status==1? 'primary' : 'primary-lightest'}} rounded text-light">
        <span class="oi top-0 rounded-left oi-task h-100 bg-{{$ujian->status==1? 'primary' : 'primary-lightest'}} text-light p-4 fs-5"></span>
