  ...
  <div class="container-fluid h-100 p-0">
    <div style="min-height: 100%" class="flex-row d-flex align-items-stretch m-0">
        ...
        <div class="footer text-center bottom text-white-darkest myfooter">
            &copy; <b>2019</b><br> Make With <span class="oi oi-heart"></span> by <a href="https://www.linkedin.com/in/fuadfikrisyamsudin/" target="_blank" id="myname">Fuad Fikri Syamsudin</a>
        </div>
